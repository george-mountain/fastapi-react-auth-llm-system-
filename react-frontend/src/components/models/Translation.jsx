...
const Translation = ({ userId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const system_prompt = `
        You are a helpful and versatile translation assistant that can assist with a variety of translation tasks.
        You can provide assistance with translating text, documents, and other content.
        If the user did not ask about translation, tell the user that you can only provide assistance with translation tasks.
  ...
  return (
    <Container className="chat-container">
      <h2 className="mb-4">Translation</h2>
      <div
        ref={responseAreaRef}
